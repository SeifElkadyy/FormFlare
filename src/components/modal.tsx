...
export function Modal({
  ...
  return (
    <dialog
      ref={ref}
      className="m-auto w-[calc(100%-2rem)] max-w-md rounded-[28px] bg-white p-0 text-neutral-900 shadow-[var(--shadow-border),0_16px_40px_oklch(0_0_0_/_0.08)] dark:bg-neutral-900 dark:text-neutral-100"
      onClose={onClose}
    >
